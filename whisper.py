...
class Whisper:
    ...
    def _set_input_file(self, input_file: str | Path) -> None:
        ...
        self._temp_wav_file = Path(f"/tmp/{self._input_file.stem}.wav")
        self._temp_srt_file = Path(f"/tmp/{self._input_file.stem}.wav.srt")
        self._log_file = Path(f"logs/{self._input_file.stem}.log")
        self._final_srt_file = self._input_file.parent / f"{self._input_file.stem}.en.srt"
